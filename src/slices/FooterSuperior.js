...
const FooterSuperior = () => {
  ...
  return(
    ...
    <div className="col-span-12 md:col-span-6 lg:col-span-4 lg:col-start-6">
      <div className="text-azul-dictuc text-base font-bold mb-3 self-start" style={{ marginLeft: '4px' }}>Certificaciones</div>
    ...
    <div className="col-span-12 md:col-span-2">
      <div className="text-azul-dictuc text-base font-bold mb-3">Entidades Relacionadas</div>
      <div>
