    ...
    const carruselData = data.allStrapiCarrusel.nodes.map(item => {
      ...
      return (
            <div className="relative z-0">
                ...
                <div id="texto-carrusel-2" className={"font-semibold absolute text-lg bottom-15 right-0 z-10 w-3/5 bg-gray-200 opacity-90 text-opacity-90 px-6 py-3 rounded-l-full" + (carruselData[indiceCarrusel].frasesVisibles === false ? " invisible" : "")}>
