...
export default function ContactoPage() {
  return (
    <PaginaInterior className="justify-center" banner={BannerTeclado} titulo="Formulario de Contacto" breadcrum={[{ label: "Home", link: "/" }, { label: "Contacto", link: "/contacto" }]}> 
    <div className="ml-auto mr-auto xl:w-2/5 lg:w-2/5 md:w-3/5 sm:w-4/5  justify-center items-center mb-6">
      <Contacto border={false} titulo="¿En qué podemos ayudarte?"/>
    </div>  
    </PaginaInterior>
  );
}
